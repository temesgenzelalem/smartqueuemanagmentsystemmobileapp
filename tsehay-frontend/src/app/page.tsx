              ...
              <div className="mt-12 rounded-3xl border p-8 text-center max-w-2xl mx-auto"
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
                  ...
                  <Link href={`/customer/signup?service=${selectedService}`}
                    className="inline-flex items-center justify-center rounded-xl px-8 py-4 font-bold text-lg transition-all border"
                    style={{ borderColor: colors.accent, color: colors.text, backgroundColor: colors.bg }}>
                    {lang === "en" ? "Sign Up" : "መመዝገብ"}
                  </Link>
                </div>
              </div>
            )}
